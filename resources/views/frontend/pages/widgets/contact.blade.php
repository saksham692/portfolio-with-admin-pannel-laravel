        ...
        <div class="row no-gutters block-9">
            <div class="col-md-6 order-md-last d-flex">
                <form action="#" class="bg-light p-4 p-md-5 contact-form" id="contact-form">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary py-3 px-5" id="submit_btn">Send Message</button>
                    </div>
                </form>
            ...
            <div class="col-md-6 d-flex">
                <div class="img" style="background-image: url({{ asset('frontend/assets') }}/images/about.jpg);"></div>
            </div>
        </div>
    </div>
</section>
