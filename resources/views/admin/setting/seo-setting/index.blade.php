                ...
                <form action="{{route('admin.seo-setting.update',1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="title" class="form-control" value="{{optional($seo)->title}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <textarea name="description" id="" class="form-control" style="height: 100px">{{optional($seo)->description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="keywords" class="form-control" value="{{optional($seo)->keywords}}">
