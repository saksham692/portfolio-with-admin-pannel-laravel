                ...
                <form action="{{route('admin.general-setting.update',1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                                <img style="width:200px" src="{{asset(optional($setting)->logo)}}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                                <img style="width:200px" src="{{asset(optional($setting)->footer_logo)}}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                                <img style="width:200px" src="{{asset(optional($setting)->favicon)}}" alt="">
                        </div>
                    </div>
                    <div class="form-group row mb-4">
