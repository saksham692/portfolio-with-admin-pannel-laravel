                ...
                <form action="{{route('admin.hero.update',1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="title" class="form-control" value="{{optional($hero)->title}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea name="sub_title" id="" class="form-control" style="height: 100px">{{optional($hero)->sub_title}}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="btn_text" class="form-control" value="{{optional($hero)->btn_text}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="btn_url" class="form-control" value="{{optional($hero)->btn_url}}">
                      </div>
                    </div>
