        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ setSidebarActive(['admin.hero.*', 'admin.typer-title.*']) }}">
                ...
                <ul class="dropdown-menu" style="display: none;">
                    ...
                    <li class="{{ setSidebarActive(['admin.typer-title.index']) }}">
                        <a class="nav-link {{ setSidebarActive(['admin.typer-title.*']) }}"
                           href="{{ route('admin.typer-title.index') }}">
                            Typing Title
                        </a>
                    </li>
            ...
            <li class="{{ setSidebarActive(['admin.project.*']) }}">
                <a class="nav-link" href="{{route('admin.project.index')}}">
                    <i class="far fa fa-medal"></i>
                    <span>Projects</span>
                </a>
            </li>
        ...
        'admin.skill-section-setting.*',
                ...
                <ul class="dropdown-menu" style="display: none;">
                    <li class="{{setSidebarActive(['admin.skill-item.*'])}}">
                        <a class="nav-link" href="{{route('admin.skill-item.index')}}">Skill
                            Items
                        </a>
                    </li>
                    <li class="{{setSidebarActive(['admin.skill-section-setting.*'])}}">
                        <a class="nav-link" href="{{route('admin.skill-section-setting.index')}}">Section
                            Setting
                        </a>
                    </li>
                </ul>
            ...
            <li class="{{setSidebarActive(['admin.education.*'])}}">
                <a class="nav-link" href="{{route('admin.education.index')}}">
                    <i class="fa far fa-book"></i>
                    <span>Education</span></a>
            </li>
            <li class="{{setSidebarActive(['admin.page.*'])}}">
        ...
        'admin.feedback-section-setting.*',
                ...
                <ul class="dropdown-menu" style="display: none;">
                    ...
                    <li class="{{setSidebarActive(['admin.feedback-section-setting.*'])}}">
                        <a class="nav-link" href="{{route('admin.feedback-section-setting.index')}}">
                            Section Setting
                        </a>
                    </li>
                </ul>
